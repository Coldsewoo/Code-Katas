...
function dative(word) {
    ...
    for (let i = 0; i < word.length; i++) {
        ...
        charCode
        if (front_vowel.indexOf(charCode) > -1) result = "nek"
        if (back_vowel.indexOf(charCode) > -1) result = "nak"
    }
    result
    word += result;
    return word;
}
var front_vowel = ["e", "é", "i", "í", "ö", "ő", "ü", "ű"].map(e => e.charCodeAt(0));
var back_vowel = ["a", "á", "o", "ó", "u", "ú"].map(e => e.charCodeAt(0));
front_vowel
back_vowel
dative("ablak") //?
