...
function fizzBuzzCuckooClock(time) {
  ...
  if (minute === '00') {
    if (hour === '00' || hour === '12') return repeat('Cuckoo', 12);
    return repeat('Cuckoo', hour % 12);
  }
  if (minute === '30') return 'Cuckoo';
  if (parseInt(minute) % 15 === 0) return 'Fizz Buzz';
  if (parseInt(minute) % 5 === 0) return 'Buzz';
  if (parseInt(minute) % 3 === 0) return 'Fizz';
  return 'tick';
}

fizzBuzzCuckooClock('5:02');
